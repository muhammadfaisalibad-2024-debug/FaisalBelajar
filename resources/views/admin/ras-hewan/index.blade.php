...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('ras-hewan.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('ras-hewan.edit', $breed->idras_hewan) }}" class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('ras-hewan.destroy', $breed->idras_hewan) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                            @csrf
                                            @method('DELETE')
