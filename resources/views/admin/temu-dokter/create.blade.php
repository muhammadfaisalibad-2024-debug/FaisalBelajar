...
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="bi bi-calendar-check"></i> Tambah Temu Dokter</h2>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('waktu_daftar') is-invalid @enderror" 
                               id="waktu_daftar" name="waktu_daftar" value="{{ old('waktu_daftar') }}" required>
                        @error('waktu_daftar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            <option value="1" {{ old('status', '1') == '1' ? 'selected' : '' }}>Menunggu</option>
