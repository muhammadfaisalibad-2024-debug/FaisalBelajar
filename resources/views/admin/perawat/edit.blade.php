...
<div class="container py-4">
    <div class="mb-4">
        <h2><i class="bi bi-hospital"></i> Edit Perawat</h2>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $perawat->nama) }}" required>
                            @error('nama')
