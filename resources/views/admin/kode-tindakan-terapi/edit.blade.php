                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" 
                                   id="kode" name="kode" value="{{ old('kode', $kodeTindakanTerapi->kode) }}" maxlength="5" required>
                            @error('kode')
                            ...
                            <select class="form-select @error('idkategori') is-invalid @enderror" 
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->idkategori }}" 
                                        {{ old('idkategori', $kodeTindakanTerapi->idkategori) == $category->idkategori ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('deskripsi_tindakan_terapi') is-invalid @enderror" 
                                   ...
                                   value="{{ old('deskripsi_tindakan_terapi', $kodeTindakanTerapi->deskripsi_tindakan_terapi) }}" maxlength="100" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('idkategori_klinis') is-invalid @enderror" 
                                ...
                                @foreach($clinicalCategories as $clinical)
                                    <option value="{{ $clinical->idkategori_klinis }}" 
                                        {{ old('idkategori_klinis', $kodeTindakanTerapi->idkategori_klinis) == $clinical->idkategori_klinis ? 'selected' : '' }}>
