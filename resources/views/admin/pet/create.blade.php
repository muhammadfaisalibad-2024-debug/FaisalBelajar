...
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="fas fa-paw"></i> Tambah Hewan Peliharaan</h2>
    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('idjenis_hewan') is-invalid @enderror" 
                                ...
                                @foreach($animalTypes as $type)
                                    <option value="{{ $type->idjenis_hewan }}">{{ $type->nama_jenis_hewan }}</option>
                                @endforeach
                            </select>
                            @error('idjenis_hewan')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('idras_hewan') is-invalid @enderror" 
                                    ...
                                    name="idras_hewan" 
                                    required>
                                <option value="">-- Pilih Jenis Hewan Dulu --</option>
                            </select>
                            @error('idras_hewan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
