...
<div class="container">
    <div class="mb-4">
        <h2><i class="fas fa-edit"></i> Edit Detail Rekam Medis</h2>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('perawat.detail-rekam.update', $detailRekam->iddetail_rekam_medis) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <select name="idkode_tindakan_terapi" id="idkode_tindakan_terapi" class="form-select @error('idkode_tindakan_terapi') is-invalid @enderror" required>
                        ...
                        @foreach($therapyCodes as $code)
                            <option value="{{ $code->idkode_tindakan_terapi }}" {{ old('idkode_tindakan_terapi', $detailRekam->idkode_tindakan_terapi) == $code->idkode_tindakan_terapi ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="detail" id="detail" rows="4" 
                              ...
                              required>{{ old('detail', $detailRekam->detail) }}</textarea>
